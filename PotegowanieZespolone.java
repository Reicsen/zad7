...
public class PotegowanieZespolone extends Application
{
    ...
    public void start(Stage baza)
    {
        ...
        podajczrzeczywista.setFont(Font.font("Callibri", 15));
        podajczrzeczywista.setWrapText(true);
        Label polecenie2 = new Label("Podaj część rzeczywistą liczby zespolonej");
        ...
        podajczurojona.setFont(Font.font("Callibri", 15));
        ...
        uruchom.setMaxWidth(300);
        uruchom.setMinWidth(300);
        Label wynik = new Label();
        wynik.setFont(Font.font("Callibri", 15));
        ...
        wyczysc.setMaxWidth(300);
        wyczysc.setMinWidth(300);
